   ...
   <div class="main-container d-flex padding-media">
      ...
      <div class="content bg-light">
              ...
              <ul class="navbar-nav mb-2 mx-3 mb-lg-0 d-flex flex-row justify-content-start align-items-center text-center gap-3 ms-4">
                <li class="nav-item hide">
                  <div class="d-flex flex-row">
                    ...
                    <p class="text-dark fw-light">&nbsp;Total Tickets</p>
                  </div>
                </li>
              </ul>
        ...
        >
          ...
          <div class="d-flex align-items-center">
            <p class="mb-2 me-3">
              <a href="/LiveHelp/about-us" class="text-secondary text-decoration-none"
                >About us</a
              >
            </p>
            <p class="mb-2">
              <a href="/LiveHelp/terms-and-conditions" class="text-secondary text-decoration-none"
    ...
    $.ajax({
        ...
        success: function (istoricResponse) {
            ...
            $.when(
                ...
                console.log("Tichet Response:", tichetResponse[0]);
                console.log("Utilizator Response:", utilizatorResponse[0]);
                console.log("Categorie Response:", categorieResponse[0]);
